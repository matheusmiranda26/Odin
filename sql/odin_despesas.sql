...
CREATE TABLE `despesas` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_despesas_fornecedores1_idx` (`idFornecedor`),
  CONSTRAINT `fk_despesas_fornecedores1` FOREIGN KEY (`idFornecedor`) REFERENCES `fornecedores` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
